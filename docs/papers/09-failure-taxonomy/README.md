# Paper 9 — Failure Taxonomy for AI-Assisted Debugging

[Read the navigable paper](failure-taxonomy-for-ai-assisted-debugging.md) · [Download PDF](failure-taxonomy-for-ai-assisted-debugging.pdf)
